...
namespace Common.Microsoft.EntityFrameworkCore
{
    ...
    {
        private IDictionary<string, Expression<Func<TEntity, bool>>> _lookup;
        private readonly string _filterExpression;

        public TValue Value { get; }
        public string EqualitySymbol { get; }
        ...
        private Expression<Func<TEntity, bool>> LookupExpression()
        {
            ...
            if (!_lookup.TryGetValue(EqualitySymbol, out Expression<Func<TEntity, bool>> value))
        ...
        {
            string[] filterTokens = filterExpression.Split(":");
